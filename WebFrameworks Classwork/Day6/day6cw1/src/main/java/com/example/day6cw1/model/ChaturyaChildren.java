...
public class ChaturyaChildren {
    ...
    public ChaturyaChildren() {
    }
    public ChaturyaChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;

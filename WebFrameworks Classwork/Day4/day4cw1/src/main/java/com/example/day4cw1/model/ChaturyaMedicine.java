...
public class ChaturyaMedicine {
    ...
    public ChaturyaMedicine() {
    }
    public ChaturyaMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
